<?php
    ...
    try {
        ...
        $mail->Username   = // 'coloque seu e-mail';                     //SMTP username
        $mail->Password   = //'coloque sua senha';                               //SMTP password
        $mail->SMTPSecure = 'tls';         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
        $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

        //Recipients
        $mail->setFrom(//'coloque seu e-mail', 'coloque o Remetente');
        ...
        $mail->AltBody = 'É necessário utilizar um client que suporte HTML para ter acesso total conteúdo dessa mensagem.';
